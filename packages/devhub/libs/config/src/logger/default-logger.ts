...
import { AppLogger, Logger, LogLevel } from './app-logger';

const DEFAULT_CONTEXT = 'DevHub Server';

/**
 * @description
 * 默认日志实现，可由 AppConfig 配置指定不同的日志级别以及时间戳形式,
 * 当前的默认日志级别是 `LogLevel.Info`
 *
 * @example
 * ```ts
 * import { DefaultLogger, LogLevel, AppConfig } from '@libs/core';
 *
